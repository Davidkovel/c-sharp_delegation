...
public class NumberHandler
{
    ...
    {
        bool isEven = CheckEven.Invoke(number);
        bool isOdd = CheckOdd.Invoke(number);
        bool isPrime = CheckPrime.Invoke(number);
        bool isFibonacci = CheckFibonacci.Invoke(number);
